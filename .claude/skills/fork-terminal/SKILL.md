---
name: fork-terminal
description: This skill should be used when the user asks to "fork a terminal", "run in a new window", "delegate to codex", or "run opencode". Provides terminal forking to new windows with Claude Code, Codex CLI, OpenCode CLI, or raw commands.
version: 1.2.0
category: terminal
context: fork
user-invocable: true
